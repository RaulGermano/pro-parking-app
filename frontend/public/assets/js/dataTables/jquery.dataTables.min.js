...
(function(h) {
	...
	function Ca(a) {
		var b = m.defaults.oLanguage,
			c = a.sZeroRecords;
		!a.sEmptyTable &&
			(c && 'Nenhum resultado obtido. Tente outro filtro ou recarregue a página, por favor.' === b.sEmptyTable) &&
	...
	m.defaults = {
		...
		oLanguage: {
			...
			sEmptyTable: 'Nenhum resultado obtido. Tente outro filtro ou recarregue a página, por favor.',
			sInfo: '<span class="btn btn-sm btn-danger curs-cont-menu text-white shadow-flash">Total: _TOTAL_</span>',
			// Página _START_ com _END_ seleções de _TOTAL_
			sInfoEmpty: '<span class="btn btn-sm btn-danger curs-cont-menu text-white shadow-flash">Total: 0</span>',
			// Página 0 com 0 seleções de 0
			sInfoFiltered: '',
			sInfoPostFix: '',
			sDecimal: '',
			sThousands: ',',
			...
			sSearch: "<span style='float: left;'>FILTRO GERAL</span>",
			sSearchPlaceholder: 'Pesquisar',
			sUrl: '',
			sZeroRecords:
				'Nenhum resultado obtido. Tente outro filtro ou recarregue a página, por favor.'
		},
