...
class Login extends Component {
    ...
    authenticationUser = async (login, password) => {
        const res = await Api.post("/authenticate-client", {
            login,
            password
        });

        if (res.data) {
            this.createLog(res.data);
    ...
    createLog = async (informations) => {
        await AsyncStorage.setItem("userId", JSON.stringify(informations));
        ...
        return (
            ...
            >
                ...
                <View style={styles.options}>
                    <SecondaryButton title="Entrar" onPress={this.tryAuthentication} />

                    <View style={styles.containerSeparetor} />

                    <PrimaryButton title="Novo usuário" onPress={this.openSignUp} />
                </View>
            </Animatable.View>
        );
    }
